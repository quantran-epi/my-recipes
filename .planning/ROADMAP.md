...
- [x] 02-02: Defer or split expensive modal/detail work so shells open promptly.
...
- [x] 03-01: Isolate startup shared-sync checks from first usable list interactions.
