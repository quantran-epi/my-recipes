...
- [ ] **Phase 1: Measurement and Performance Harness** - Make large-list and online/offline responsiveness reproducible and measurable.
...
|-------|----------------|--------|-----------|
| 1. Measurement and Performance Harness | 0/3 | Not started | - |
